...
<head>
    ...
    <title>20 Câu Hỏi Điểm Liệt A1 - Thi Thử 2025</title>
    ...
    <div class="container main-content">
        ...
        <div class="exam-section">
            ...
            if ($result->num_rows > 0) {
                ...
                echo '
                <a href="thi-thu-20-cau-diem-liet-a1.php?set_id=' . $row['set_id'] . '" class="exam-card-large">
                    <div class="exam-card-content">
                        <div class="exam-icon-large">
                            <i class="fas fa-clipboard-list"></i>
                        </div>
                        <div class="exam-info-large">
                            <h3>Bộ Đề 20 Câu Điểm Liệt</h3>
        ...
        <div class="related-section">
            <h3>Sau khi thuộc 20 câu điểm liệt</h3>
            <div class="related-links">
                <a href="thi-bang-lai-xe-a1-online.php" class="related-card">
                    <i class="fas fa-arrow-right"></i>
                    <span>Tiếp tục với 8 đề thi A1 đầy đủ</span>
                </a>
            </div>
        </div>
