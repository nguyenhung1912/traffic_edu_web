...
<head>
    ...
    <title>Thi Thử Bằng Lái Xe A2 Online 2025</title>
...
<body>
    ...
    <div class="container main-content">
        ...
        <div class="hero-section">
            <h1 class="hero-title">Thi Thử Bằng Lái Xe A2</h1>
            <p class="hero-subtitle">450 câu hỏi chuẩn - 18 đề thi - Miễn phí 100%</p>
        ...
        <div class="exam-section">
            ...
            <!-- Đề Điểm Liệt -->
            <a href="thi-thu-50-cau-diem-liet-a2.php" class="exam-card special">
                <div class="exam-icon">
                    <i class="fas fa-exclamation-triangle"></i>
                </div>
                <div class="exam-info">
                    <h3>50 Câu Điểm Liệt</h3>
            ...
            <div class="exam-grid-modern">
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        if ($count <= 18) {
                            echo '
                            <a href="thi-thu-bang-lai-xe-may-a2.php?set_id=' . $row['set_id'] . '" class="exam-card">
